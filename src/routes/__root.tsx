  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocorreu um problema. Tente atualizar ou volte para o início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Gadelha Hair — Agenda" },
      {
        name: "description",
        content: "Sistema de agendamentos do salão Gadelha Hair.",
      },
      { name: "author", content: "Gadelha Hair" },
      { name: "theme-color", content: "#211713" },
      ...
      { name: "apple-mobile-web-app-title", content: "Gadelha Hair" },
      { property: "og:title", content: "Gadelha Hair — Agenda" },
      {
  ...
  useEffect(() => {
    ...
    const registerServiceWorker = async () => {
      try {
        ...
        console.info("PWA ativa:", registration.scope);
      } catch (error) {
